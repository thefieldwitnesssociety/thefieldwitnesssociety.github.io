...
The visual system uses Univers for institutional display headings, EB Garamond for editorial titles and prose, and Submariner for navigation and field metadata. The home page has a full-width cover with the existing title, followed only by the project introduction and “Explore the field notes”. It uses the supplied mountaineers photograph on desktop and the van with lightning on screens up to 640px wide. Both JPEGs are unchanged copies of the supplied files, with their original proportions. The title sits over open sky on desktop and the road on mobile to leave the main subjects visible.

The Field Notes index presents each publication as one bordered, fully clickable postcard with a single photograph, title, introduction, field date and media credit. The photograph sits beside the text on desktop and above it on smaller screens. There are no interior divider lines; spacing and each card’s outline separate the entries. Contacts contains the email address and existing email composer, without a photograph. About opens with its title and introduction, without a photograph. The full Field Note article retains its photographs and factual content; its downloadable PDF is unchanged. The previously requested removal of the About paragraph beginning “The Society is developing its first programme of Field Notes” remains in place. A final English copy edit corrects syntax and wording in About, Contacts, the Field Note and the privacy notice. Logos, fonts, navigation, privacy provisions and contact behaviour are preserved. No additional runtime scripts, tracking services or data storage have been added. Reduced-motion preferences are respected.
