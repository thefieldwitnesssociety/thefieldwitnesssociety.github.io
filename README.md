...
The Field Notes index uses one photograph per publication, beside its title, introduction, date and link on desktop, and above the text on smaller screens. Contacts contains the email address and existing email composer, without a photograph. The full Field Note article and its downloadable PDF retain their photographs and content. The previously requested removal of the About paragraph beginning “The Society is developing its first programme of Field Notes” remains in place. Logos, fonts, navigation, privacy content and contact behaviour are preserved. No additional runtime scripts, tracking services or data storage have been added. Reduced-motion preferences are respected.
